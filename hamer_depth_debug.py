...
def main(demo_path, debug):
    ...
    for i in tqdm(range(len(rgb_paths))): 
        ...
        # Save data
        out_path = demo_path.replace("/juno/u/oliviayl/repos/cross_embodiment/FoundationPose/demo_data/final_scene/", "/juno/u/oliviayl/repos/cross_embodiment/human_shadow/outputs_depth_final_CLUSTER/")
        print(out_path)
