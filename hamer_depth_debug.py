    ...
    for i in tqdm(range(len(rgb_paths))):
        ...
        if debug:
            o3d.io.write_point_cloud(
                os.path.join(
                    "/juno/u/oliviayl/repos/cross_embodiment/human_shadow/original.pcd"
                ),
                pcd,
            )
            o3d.io.write_point_cloud(
                os.path.join(
                    "/juno/u/oliviayl/repos/cross_embodiment/human_shadow/aligned_hamer_pcd.pcd"
                ),
                aligned_hamer_pcd,
            )
            o3d.io.write_point_cloud(
                os.path.join(
                    "/juno/u/oliviayl/repos/cross_embodiment/human_shadow/finger_pcd.pcd"
                ),
                finger_pcd,
            )
