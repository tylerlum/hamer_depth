...
import human_shadow.camera.ogl_viewer.zed_model as zm
        ...
        if camera_model == sl.MODEL.ZED:
            for i in range(0, zm.NB_ALLUMINIUM_TRIANGLES * 3, 3):
                for j in range(3):
                    ...
                    self.zedModel.add_point_clr(
                        [
                            zm.vertices[index * 3],
                            zm.vertices[index * 3 + 1],
                            zm.vertices[index * 3 + 2],
                        ],
                        [
                            zm.ALLUMINIUM_COLOR.r,
                            zm.ALLUMINIUM_COLOR.g,
                            zm.ALLUMINIUM_COLOR.b,
                        ],
                    )
            ...
            for i in range(0, zm.NB_AL_ZEDM_TRI * 3, 3):
                for j in range(3):
                    ...
                    self.zedModel.add_point_clr(
                        [
                            zm.vertices_m[index * 3],
                            zm.vertices_m[index * 3 + 1],
                            zm.vertices_m[index * 3 + 2],
                        ],
                        [
                            zm.ALLUMINIUM_COLOR.r,
                            zm.ALLUMINIUM_COLOR.g,
