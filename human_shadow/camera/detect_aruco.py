...
def main(args):
    ...
    charuco_detector, charuco_board = init_charuco_detector(
        checker_size=0.020,
        marker_size=0.016,
        ncols=14,
        nrows=9,
    ...
    while True:
        if zed.grab() == sl.ERROR_CODE.SUCCESS:
            ...
            if args.mode == "marker":
                annotated_img, rvec, tvec = get_aruco_marker_pose(
                    img_left_rgb,
                    aruco_detector,
                    camera_matrix,
                    marker_id=0,
                ...
                annotated_img, rvec, tvec = get_charuco_board_pose(
                    img_left_rgb, camera_matrix, charuco_detector, charuco_board
                )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--mode", type=str, default="marker", choices=["marker", "board"]
    )
