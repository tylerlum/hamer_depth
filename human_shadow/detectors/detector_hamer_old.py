...
sys.path.append("/juno/u/oliviayl/repos/cross_embodiment/hamer")
...
class DetectorHamer:
    def __init__(self):
        root_dir = "/juno/u/oliviayl/repos/cross_embodiment/human_shadow/hamer"  # get_parent_folder_of_package("hamer")
    ...
    def detect_hand_keypoints(
        ...
        bboxes, is_right, debug_bboxes = self.get_bboxes_for_hamer(
            img, hand_type=hand_type, use_vitposes=use_vitposes
        )
        ...
        list_2d_kpts, list_3d_kpts, list_verts, T_cam_pred_all = [], [], [], []
        kpts_2d_hamer = None
    ...
    def get_bboxes_for_hamer(
        self, img: np.ndarray, hand_type: HandType, use_vitposes: bool = True
