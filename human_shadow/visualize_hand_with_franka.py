...
def main(args):
    ...
    while True:
        ...
        update_marker_pos(
            redis_pipe,
            "redisgl::human_shadow::markers_hand_ee::model::object::hand_ee",
            pos=hand_ee_pt.tolist(),
        )
        update_marker_pos(
            redis_pipe,
            "redisgl::human_shadow::markers_thumb::model::object::thumb",
            pos=thumb_pt.tolist(),
        )
        update_marker_pos(
            redis_pipe,
            "redisgl::human_shadow::markers_middle::model::object::middle",
            pos=middle_pt.tolist(),
        )
