...
def get_hand_pose(detector_bbox, detector_hamer, segmentor, video_folder, video_num):
    ...
    print("First idx: ", idx)
    # # Segment hand
    # # plot bbox on first image of video 
    # img_rgb = left_imgs[0]
    # img_bgr = img_rgb[..., ::-1]
    # img_bgr = np.ascontiguousarray(img_bgr)
    # cv2.rectangle(img_bgr, (bbox[0], bbox[1]), (bbox[2], bbox[3]), (0, 255, 0), 2)
    # # plot kpts_2d
    # for kpt in kpts_2d.astype(np.int32):
    #     cv2.circle(img_bgr, tuple(kpt), 5, (0, 0, 255), -1)
...
if __name__ == '__main__':
    ...
    # Change the dir_path
    dir_path = "/juno/u/lepertm/shadow/human_shadow/human_shadow/data/videos/demo_marion_calib_2"
