...
def main():
    ...
    for img_idx in tqdm(range(len(image_paths))):
    ...
    # Save data
    df.to_csv(os.path.join(video_folder, "finger_poses.csv"))
    media.write_video(os.path.join(video_folder, "imgs_pcd.mp4"), np.array(list_pcd_imgs), fps=10)
    media.write_video(os.path.join(video_folder, "imgs_hamer.mp4"), np.array(list_hamer_imgs), fps=10)
    media.write_video(os.path.join(video_folder, "imgs_sam.mp4"), np.array(sam_imgs), fps=10)
    media.write_video(os.path.join(video_folder, f"imgs_annot.mp4"), np.array(list_annot_imgs), fps=10)
